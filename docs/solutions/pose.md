...
*   `presence`: A value in `[0.0, 1.0]` indicating the likelihood of the
    landmark being present in the image.
...
*   Android target: [(or download prebuilt ARM64 APK)](TODO\(b/174431108\))
...
[web demo]:https://mediapipe.dev/demo/pose
